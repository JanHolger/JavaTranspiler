...
array_unshift($s,$l[1]);
ins6:
array_unshift($s,$v->invoke($t, "java/lang/String","valueOf","(Ljava/lang/Object;)Ljava/lang/String;",[array_splice($s,0,1)[0]]));
if ($t['exception'] != NULL) {
goto ret;
}
ins9:
...
array_unshift($s,$l[1]);
ins6:
array_unshift($s,$v->invoke($t, "java/lang/String","valueOf","(F)Ljava/lang/String;",[array_splice($s,0,1)[0]]));
if ($t['exception'] != NULL) {
goto ret;
}
ins9:
...
array_unshift($s,$l[1]);
ins6:
array_unshift($s,$v->invoke($t, "java/lang/String","valueOf","(D)Ljava/lang/String;",[array_splice($s,0,1)[0]]));
if ($t['exception'] != NULL) {
goto ret;
}
ins9:
...
array_unshift($s,$l[1]);
ins6:
array_unshift($s,$v->invoke($t, "java/lang/String","valueOf","(C)Ljava/lang/String;",[array_splice($s,0,1)[0]]));
if ($t['exception'] != NULL) {
goto ret;
}
ins9:
...
array_unshift($s,$l[1]);
ins6:
array_unshift($s,$v->invoke($t, "java/lang/String","valueOf","(J)Ljava/lang/String;",[array_splice($s,0,1)[0]]));
if ($t['exception'] != NULL) {
goto ret;
}
ins9:
...
array_unshift($s,$l[1]);
ins6:
array_unshift($s,$v->invoke($t, "java/lang/String","valueOf","(Z)Ljava/lang/String;",[array_splice($s,0,1)[0]]));
if ($t['exception'] != NULL) {
goto ret;
}
ins9:
...
array_unshift($s,$l[1]);
ins6:
array_unshift($s,$v->invoke($t, "java/lang/String","valueOf","(I)Ljava/lang/String;",[array_splice($s,0,1)[0]]));
if ($t['exception'] != NULL) {
goto ret;
}
ins9:
...
"(I)Ljava/lang/String;" => [
"code" => function($v,$t,$l,$s){
return $v->newstring(strval($l[0]['value']));
},
"name" => "valueOf",
"flags" => [
"private" => false,
...
array_unshift($s,$l[0]);
ins5:
array_unshift($s,$v->getfield($t,"java/lang/Throwable","message",array_shift($s)));
ins8:
goto ret;
ret:
return array_unshift($s);
...
array_unshift($s,$l[1]);
ins10:
$v->setfield($t,"java/lang/Throwable","message",array_splice($s,1,1)[0],array_shift($s));
ins13:
array_unshift($s,$l[0]);
ins14:
array_unshift($s,$l[2]);
ins15:
$v->setfield($t,"java/lang/Throwable","cause",array_splice($s,1,1)[0],array_shift($s));
ins18:
array_unshift($s, NULL);
goto ret;
ret:
...
array_unshift($s,$l[0]);
ins5:
array_unshift($s,$v->getfield($t,"java/lang/Throwable","cause",array_shift($s)));
ins8:
goto ret;
ret:
return array_unshift($s);
