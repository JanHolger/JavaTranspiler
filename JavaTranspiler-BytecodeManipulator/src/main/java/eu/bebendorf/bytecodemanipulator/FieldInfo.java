...
public class FieldInfo {
    ...
    public static FieldInfo read(ClassFile classFile, ByteBuffer bb) {
        ...
        return new FieldInfo(classFile, new Flags(accessFlags), nameIndex, descriptorIndex, attributes);
    }
